...
return array(
  ...
  'Bot token' => 'โทเคนบอท',
  'Bot Username' => 'ชื่อผู้ใช้บอท',
  'Telegram Chat ID' => 'ID แช็ต Telegram',
  'Telegram Chat ID for receiving task notifications' => 'ID แช็ต Telegram สำหรับรับการแจ้งเตือนงาน',
