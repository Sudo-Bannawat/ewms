...
return array(
  ...
  'Bot token' => 'Token ຂອງບອດ',
  'Bot Username' => 'ຊື່ຜູ້ໃຊ້ບອດ',
  'Telegram Chat ID' => 'ID Chat ຂອງ Telegram',
  'Telegram Chat ID for receiving task notifications' => 'ID Chat ຂອງ Telegram ສຳລັບຮັບການແຈ້ງເຕືອນວຽກ',
